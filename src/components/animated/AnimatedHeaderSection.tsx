        ...
        <div style={{clipPath:"polygon(0 0,100% 0,100% 100%, 0 100%"}}>
            <div 
             ...
             className='flex flex-col justify-center gap-12 pt-15 sm:gap-16'>
                ...
                <div className='px-10'>
                    <h1 className={`flex flex-col text-6xl font-bold flex-wrap gap-12  uppercase sm:gap-15 md:block text-transparent bg-clip-text`}
style={{
  backgroundImage: 'linear-gradient(120deg,rgb(235, 223, 250),rgb(176, 0, 211),rgb(226, 202, 43))',
